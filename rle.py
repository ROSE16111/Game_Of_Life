...
class RunLengthEncodedParser:
    ...
    def __init__(self, rle_string):
        ...
        self.populate_attributes(self.rle_string.strip().splitlines()) # remove all spaces at the beginning and at the end of the string:
            ...
            # Grid sizes and rules
                ...
                for d in data:
                    ...
                    if d.strip().startswith("x"):
                        _, x = d.split("=") # 解构赋值 like:d:1=3 ; a,b = d.split("="); a=1,b=3; _ means sth ignored(not important)
